...
class Carte_Monument{
  ...
  */
  ...
  Description : Cette methode permet de retourner le booléen afin de savoir si un monument est construit ou non
  */
  ...
  Entree : 
      ...
      - construct : booléen indiquant si le monument est construit ou non (false par default)
  ...
  */
  ...
  Description : Cette methode permet de detruire la classe (utilisation du destructeur par défault)
  */
  ...
  */
  ...
  Sortie : Affichage
  Description : Cette fonction permet d'effectuer l'affichage d'une Carte_Monument sur un flux f
  */
