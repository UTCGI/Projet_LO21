...
class Partie{
    ...
    SPECIFICATION : Partie::Partie()
        ...
        Elle devra initialiser chaque attributs de la classe partie avec des valeurs par default.
    */
    Partie();
    ...
    SPECIFICATION : Partie::~Partie()
        ...
        Pour cela, elle libérera les joueurs, jeu et réserves allouées dynamiquement.
    */
    ~Partie();
    ...
    SPECIFICATION : Partie::initialisation()
        Entree: None
        Sortie: None
        Objectif: ??? Cette fonction est elle vraiment utilise ?? puisque l'initialisation se faire
        déjà dans le construicteur de la classe partie. A vérifier 
        -> Si elle est vraiment utile, je n'ai pas compris ce qu'elle devais faire.
    */
    void initialisation();
    ...
    SPECIFICATION : Partie::distribuer()
        Entree: None
        Sortie: None
        Objectif: Cette fonction distribueras les cartes de base dans les piles des joueurs au début de la partie
        A savoir : La ferme et Le champ de blé
    */
    void distribuer();
    ...
    */
    ...
    SPECIFICATION : Partie::regarder_etablissements(Joueur joueur, Couleur couleur)
        Entree: Joueur joueur, Couleur couleur
        Sortie: Tableau d'établissements
        Objectif: Cette fonction renvoie tout les établissements que dispose le joueur selon
        la couleur passée en paramêtre.
    */
    ...
    */
    ...
    /*
    SPECIFICATION : Partie::transaction_piece(Joueur emeteur, Joueur destinataire, int montant)
        Entree: Joueur emeteur, Joueur destinataire, int montant
        Sortie: None
    ...
    */
    ...
    SPECIFICATION : Partie::transaction_carte(Joueur emeteur, Joueur destinataire, Pile pile)
        Entree: Joueur emeteur, Joueur destinataire, Pile pile
        Sortie: None
        Objectif: Cette fonction effectue une transaction entre le joueur emeteur et le joueur destinataire
