...
class Jeu{
    ...
    const Etablissement** liste_etablissements_depart = new const Etablissement * [2];
    //const Etablissement* liste_etablissements_depart[2];
    Extension extension = null;//Extension::Standard;
    //Extension::Marina;
    size_t condition_de_victoire = 4; //nombre de monuments à construire pour gagner dans le jeu de base
    //=6;
    size_t nb_joueurs_MAX = 4; //nombre de joueurs max dans le jeu de base
    //=4;
    size_t nb_pile_reserve_MAX = 15; //nombre de piles max dans la réserve du jeu de base : 3 lignes ; 5 colonnes
