...
Jeu::Jeu() {
	...
	Etablissement champs_de_ble = new Etablissement("Champs de ble", Couleur::Bleu, "Recevez 1 piece de la banque", 1, 1, Type::agriculture, 1, Type::aucun, null, 6);
	Etablissement ferme = new Etablissement("Ferme", Couleur::Bleu, "Recevez 1 piece de la banque", 1, 2, Type::elevage, 1, Type::aucun, null, 6);
	Etablissement boulangerie = new Etablissement("Boulangerie", Couleur::Vert, "Recevez 1 piece de la banque", 1, {2,3}, Type::commerce, 1, Type::aucun, null, 6);
	Etablissement cafe = new Etablissement("Cafe", Couleur::Rouge, "Recevez 1 piece du joueur qui a lance les des", 2, 3, Type::restauration, 1, Type::aucun, 0, 6);
	Etablissement superette = new Etablissement("Superette", Couleur::Vert, "Recevez 3 pieces de la banque", 2, 4, Type::commerce, 3, Type::aucun, null, 6);
	Etablissement foret = new Etablissement("Foret", Couleur::Bleu, "Recevez 1 piece de la banque", 3, 5, Type::ressources, 1, Type::aucun, null, 6);
	Etablissement stade = new Etablissement("Stade", Couleur::Violet, "Recevez 2 pieces de la part de chaque autre joueur", 6, 6, Type::special, 2, Type::aucun, 1, 4);
	//centre_d_affaires : type_effet=null ou type_effet=special pour faire un test d'erreur si echange special contre special
	Etablissement centre_d_affaires = new Etablissement("Centre d'affaires", Couleur::Violet, "Vous pouvez echanger avec le joueur de votre choix un etablissement qui ne soit pas de type special", 8, 6, Type::special, 0, Type::aucun, null, 4);
	Etablissement chaine_de_television = new Etablissement("Chaine de television", Couleur::Violet, "Recevez 5 pieces du joueur de votre choix", 7, 6, Type::special, 5, Type::aucun, 0, 4);
	...
	Etablissement mine = new Etablissement("Mine", Couleur::Bleu, "Recevez 5 pieces de la banque", 6, 9, Type::ressources, 5, Type::aucun, null, 6);
	Etablissement restaurant = new Etablissement("Restaurant", Couleur::Rouge, "Recevez 2 pieces du joueur qui a lance les des", 3, {9,10}, Type::restauration, 2, Type::aucun, 0, 6);
	Etablissement verger = new Etablissement("Verger", Couleur::Bleu, "Recevez 3 pieces de la banque", 3, 10, Type::agriculture, 3, Type::aucun, null, 6);
	...
	Monument tour_radio = new Monument("Tour radio", "Une fois par tour, vous pouvez choisir de relancer vos des", 22, 4);
	...
	//setPrix(0);setNb_exemplaire(4);
	//Etablissement(nom,couleur,effet,prix,num_de[],type,nb_piece,type_effet,payeur,nb_exemplaire);
	Etablissement champs_de_ble_depart = new Etablissement("Champs de ble", Couleur::Bleu, "Recevez 1 piece de la banque", 0, 1, Type::agriculture, 1, Type::aucun, null, 4);
	Etablissement boulangerie_depart = new Etablissement("Boulangerie", Couleur::Vert, "Recevez 1 piece de la banque", 0, { 2,3 }, Type::commerce, 1, Type::aucun, null, 4);
